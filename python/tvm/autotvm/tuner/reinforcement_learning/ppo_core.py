        ...
        with tf.variable_scope(name):
            ...
            with tf.variable_scope('policy_net'):
                ...
                for i in range(len(self.act_space)):
                    ...
                    self.act_probs.append(tf.layers.dense(inputs=tf.divide(layer_4, temp), units=self.act_space[i],
...
class PPOAgent:
    ...
    def observe_all_and_learn(self, rewards):
        ...
        if self.horizon != -1:
            ...
            horizon_samples = [np.take(a=input_sample, indices=horizon_indices, axis=0) for input_sample in
                               input_samples]
        ...
        for epoch in range(self.epochs):
            ...
            if self.horizon != -1:
                ...
                batch_samples = [np.take(a=input_sample, indices=batch_indices, axis=0) for input_sample in
                                 horizon_samples]
            else:
